/* ═══════════════════════════════════════════════════════════
   ...
   يحتوي على: الثوابت، الأدوات، التشفير، الحالة، تتبع الأخطاء
   ═══════════════════════════════════════════════════════════ */
...
(function () {
    ...
    // معالجات آمنة ضد Proxy في Tampermonkey
    ...
    // إصلاح: إذا كانت أول مرة → اللوحة تظهر
    if (savedRaw === null) {
        NS.state.collapsed = false;
    }

    // ربط مع window لتجنب TDZ
    window.__bskyState = NS.state;

    // تأكد من أن كل المصفوفات موجودة
